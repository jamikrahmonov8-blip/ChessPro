        ...
        <main className="min-h-full flex items-center justify-center p-12 gap-12 max-w-6xl mx-auto w-full">
                        ...
                        {themes.map((theme) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`p-4 bg-slate-950/60 border rounded-2xl flex items-center justify-between text-left transition-all ${isSelected
            ...
            >
                ...
                <div className="p-2 bg-slate-900/20 rounded-2xl border border-slate-800 shadow-2xl backdrop-blur-sm">
                    <Chessboard
                        position="r1bqkbnr/pppp1ppp/2n5/1B2p3/4P3/5N2/PPPP1PPP/RNBQK2R b KQkq - 1 3"
                        arePiecesDraggable={false}
                        customDarkSquareStyle={{ backgroundColor: activeStyle.dark }}
                        customLightSquareStyle={{ backgroundColor: activeStyle.light }}
                        boardWidth={320}
                        {...({} as any)} // Этим трюком мы глушим строгую ошибку типов TypeScript для Vercel
                    />
                </div>
            </motion.div>
